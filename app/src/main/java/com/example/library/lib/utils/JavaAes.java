...
public final class JavaAes {
    ...
    public static String doEncryptedAES(String msj, String key) {
        ...
        try {
            ...
            msjEncrypted = Base64.encodeToString(msjEncryptedbyte,Base64.DEFAULT);
            return msjEncrypted;
    ...
    public static String doDecryptedAES(String msjEncrypted, String key) {
        ...
        byte[] keyByte;
        try {
            msjEncryptedByte = Base64.decode(msjEncrypted.getBytes(StandardCharsets.UTF_8),Base64.DEFAULT);
            keyByte = getKeyBytes(key);
